...
- **Files with very large lines**, because the complete matching line and, by default, surrounding context are stored for every match. Minified JavaScript, generated JSON, and one-line data dumps are common examples for which `seekr` may not be the best fit.
