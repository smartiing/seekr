...
#> Common Path: /tmp/RtmpA8CKDu/seekr-example/extdata
#> 
#> server1.log [10/40]
...
#>   <chr>                                                 <int>              <int>      <int>     <int>
#> 1 /tmp/RtmpA8CKDu/seekr-example/extdata/server1.log        12                  6          2        38
#> 2 /tmp/RtmpA8CKDu/seekr-example/extdata/server2.log         8                  5          5        36
```
...
#> 1     1 2026-07-07 10:09:10 replace   NA          /tmp/RtmpA8CKDu/seekr-example/extdata/server1.log /tmp/RtmpA8CK… TRUE            TRUE          1.76K
#> 2     1 2026-07-07 10:09:10 replace   NA          /tmp/RtmpA8CKDu/seekr-example/extdata/server2.log /tmp/RtmpA8CK… TRUE            TRUE           1.8K
