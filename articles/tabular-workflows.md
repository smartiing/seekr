...
#> Common Path: /tmp/RtmpeQHngB/seekr-example/extdata
#> 
#> server1.log [10/40]
...
#>   <chr>                                                 <int>              <int>      <int>     <int>
#> 1 /tmp/RtmpeQHngB/seekr-example/extdata/server1.log        12                  6          2        38
#> 2 /tmp/RtmpeQHngB/seekr-example/extdata/server2.log         8                  5          5        36
```
...
#> 1     1 2026-07-07 08:37:37 replace   NA          /tmp/RtmpeQHngB/seekr-example/extdata/server1.log /tmp/RtmpeQHn… TRUE            TRUE          1.76K
#> 2     1 2026-07-07 08:37:37 replace   NA          /tmp/RtmpeQHngB/seekr-example/extdata/server2.log /tmp/RtmpeQHn… TRUE            TRUE           1.8K
