...
#> Common Path: /tmp/RtmpG8r7QO/seekr-example/extdata
#> 
#> server1.log [10/40]
...
#>   <chr>                                                 <int>              <int>      <int>     <int>
#> 1 /tmp/RtmpG8r7QO/seekr-example/extdata/server1.log        12                  6          2        38
#> 2 /tmp/RtmpG8r7QO/seekr-example/extdata/server2.log         8                  5          5        36
```
...
#> 1     1 2026-07-10 22:16:26 replace   NA          /tmp/RtmpG8r7QO/seekr-example/extdata/server1.log /tmp/RtmpG8r7… TRUE            TRUE          1.76K
#> 2     1 2026-07-10 22:16:26 replace   NA          /tmp/RtmpG8r7QO/seekr-example/extdata/server2.log /tmp/RtmpG8r7… TRUE            TRUE           1.8K
