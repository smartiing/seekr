...
#> Common Path: /tmp/Rtmp68gH2B/seekr-example/extdata
#> 
#> server1.log [10/40]
...
#>   <chr>                                                 <int>              <int>      <int>     <int>
#> 1 /tmp/Rtmp68gH2B/seekr-example/extdata/server1.log        12                  6          2        38
#> 2 /tmp/Rtmp68gH2B/seekr-example/extdata/server2.log         8                  5          5        36
```
...
#> 1     1 2026-07-06 21:50:49 replace   NA          /tmp/Rtmp68gH2B/seekr-example/extdata/server1.log /tmp/Rtmp68gH… TRUE            TRUE          1.76K
#> 2     1 2026-07-06 21:50:49 replace   NA          /tmp/Rtmp68gH2B/seekr-example/extdata/server2.log /tmp/Rtmp68gH… TRUE            TRUE           1.8K
