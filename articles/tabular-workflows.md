...
#> Common Path: /tmp/Rtmp4gH6Ow/seekr-example/extdata
#> 
#> server1.log [10/40]
...
#>   <chr>                                                 <int>              <int>      <int>     <int>
#> 1 /tmp/Rtmp4gH6Ow/seekr-example/extdata/server1.log        12                  6          2        38
#> 2 /tmp/Rtmp4gH6Ow/seekr-example/extdata/server2.log         8                  5          5        36
```
...
#> 1     1 2026-07-07 21:16:42 replace   NA          /tmp/Rtmp4gH6Ow/seekr-example/extdata/server1.log /tmp/Rtmp4gH6… TRUE            TRUE          1.76K
#> 2     1 2026-07-07 21:16:42 replace   NA          /tmp/Rtmp4gH6Ow/seekr-example/extdata/server2.log /tmp/Rtmp4gH6… TRUE            TRUE           1.8K
