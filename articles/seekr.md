...
files
#> [1] "/tmp/Rtmpt9wQv5/seekr-example/extdata/config.yaml" "/tmp/Rtmpt9wQv5/seekr-example/extdata/data.json"  
#> [3] "/tmp/Rtmpt9wQv5/seekr-example/extdata/iris.csv"    "/tmp/Rtmpt9wQv5/seekr-example/extdata/mtcars.csv" 
#> [5] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R"   "/tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R"  
#> [7] "/tmp/Rtmpt9wQv5/seekr-example/extdata/server1.log" "/tmp/Rtmpt9wQv5/seekr-example/extdata/server2.log"
```
...
#> [1] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R" "/tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R"
#> attr(,"exclusions")
#> # A tibble: 8 × 7
#>   path                                              excluded exclude_by_extension is_git_dir is_dependency_dir is_minified_file is_not_text_mime
#>   <chr>                                             <lgl>    <lgl>                <lgl>      <lgl>             <lgl>            <lgl>           
#> 1 /tmp/Rtmpt9wQv5/seekr-example/extdata/config.yaml TRUE     TRUE                 NA         NA                NA               NA              
#> 2 /tmp/Rtmpt9wQv5/seekr-example/extdata/data.json   TRUE     TRUE                 NA         NA                NA               NA              
#> 3 /tmp/Rtmpt9wQv5/seekr-example/extdata/iris.csv    TRUE     TRUE                 NA         NA                NA               NA              
#> 4 /tmp/Rtmpt9wQv5/seekr-example/extdata/mtcars.csv  TRUE     TRUE                 NA         NA                NA               NA              
#> 5 /tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R   FALSE    FALSE                FALSE      FALSE             FALSE            FALSE           
#> 6 /tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R   FALSE    FALSE                FALSE      FALSE             FALSE            FALSE           
#> 7 /tmp/Rtmpt9wQv5/seekr-example/extdata/server1.log TRUE     TRUE                 NA         NA                NA               NA              
#> 8 /tmp/Rtmpt9wQv5/seekr-example/extdata/server2.log TRUE     TRUE                 NA         NA                NA               NA
```
...
#> 1 /tmp/Rtmpt… TRUE     FALSE                TRUE                   NA                   NA         NA                NA               NA              
#> 2 /tmp/Rtmpt… TRUE     TRUE                 NA                     NA                   NA         NA                NA               NA              
#> 3 /tmp/Rtmpt… TRUE     TRUE                 NA                     NA                   NA         NA                NA               NA              
#> 4 /tmp/Rtmpt… TRUE     TRUE                 NA                     NA                   NA         NA                NA               NA              
#> 5 /tmp/Rtmpt… FALSE    FALSE                FALSE                  FALSE                FALSE      FALSE             FALSE            FALSE           
#> 6 /tmp/Rtmpt… FALSE    FALSE                FALSE                  FALSE                FALSE      FALSE             FALSE            FALSE           
#> 7 /tmp/Rtmpt… TRUE     FALSE                FALSE                  TRUE                 NA         NA                NA               NA              
#> 8 /tmp/Rtmpt… TRUE     FALSE                FALSE                  TRUE                 NA         NA                NA               NA              
#> 9 /tmp/Rtmpt… TRUE     FALSE                FALSE                  FALSE                FALSE      FALSE             FALSE            TRUE            
...
filtered_custom
#> [1] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R"
#> attr(,"exclusions")
#> # A tibble: 9 × 8
...
#> 1 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 2 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 3 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 4 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 5 /tmp/Rtmpt9wQv5/seekr-example/extdata/… FALSE    FALSE                FALSE      FALSE             FALSE            FALSE            FALSE          
#> 6 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     FALSE                FALSE      FALSE             FALSE            FALSE            TRUE           
#> 7 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 8 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA             
#> 9 /tmp/Rtmpt9wQv5/seekr-example/extdata/… TRUE     TRUE                 NA         NA                NA               NA               NA
```
...
#>   path                                              excluded
#>   <chr>                                             <lgl>   
#> 1 /tmp/Rtmpt9wQv5/seekr-example/extdata/config.yaml FALSE   
#> 2 /tmp/Rtmpt9wQv5/seekr-example/extdata/data.json   FALSE   
#> 3 /tmp/Rtmpt9wQv5/seekr-example/extdata/iris.csv    FALSE   
#> 4 /tmp/Rtmpt9wQv5/seekr-example/extdata/mtcars.csv  FALSE   
#> 5 /tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R   FALSE   
#> 6 /tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R   FALSE   
#> 7 /tmp/Rtmpt9wQv5/seekr-example/extdata/server1.log FALSE   
#> 8 /tmp/Rtmpt9wQv5/seekr-example/extdata/server2.log FALSE   
#> 9 /tmp/Rtmpt9wQv5/seekr-example/extdata/server.png  FALSE
```
...
#> Common Path: /tmp/Rtmpt9wQv5/seekr-example/extdata
#> 
#> script1.R [2]
...
#> /tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R [2]
...
#> path        <chr> "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R", "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R", "/tmp/Rtmpt9wQv5/seekr-example…
...
field(x, "path")
#> [1] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R" "/tmp/Rtmpt9wQv5/seekr-example/extdata/script1.R"
#> [3] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R" "/tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R"
#> [5] "/tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R"
```
...
#> /tmp/Rtmpt9wQv5/seekr-example/extdata/script2.R [3]
#> [1] ->  2 | mean_safe <- function(x) {
#>         3 |   if (length(x) == 0) return(NA)
#>         4 |   mean(x, na.rm = TRUE)
#>         5 | }
...
#> 1     1 2026-07-06 21:50:44 replace   Inverse function names /tmp/Rtmpt9wQv5/seekr-example/extdata/script1… /tmp/… TRUE            TRUE            161
#> 2     1 2026-07-06 21:50:44 replace   Inverse function names /tmp/Rtmpt9wQv5/seekr-example/extdata/script2… /tmp/… TRUE            TRUE            279
```
...
#>      id created_at          operation description                                       original            backup original_exists backup_exists  size
#>   <int> <dttm>              <chr>     <chr>                                             <chr>               <chr>  <lgl>           <lgl>         <fs:>
#> 1     2 2026-07-06 21:50:44 restore   restore after reversing function names by mistake /tmp/Rtmpt9wQv5/se… /tmp/… TRUE            TRUE            161
#> 2     2 2026-07-06 21:50:44 restore   restore after reversing function names by mistake /tmp/Rtmpt9wQv5/se… /tmp/… TRUE            TRUE            279
#> 3     1 2026-07-06 21:50:44 replace   Inverse function names                            /tmp/Rtmpt9wQv5/se… /tmp/… TRUE            TRUE            161
#> 4     1 2026-07-06 21:50:44 replace   Inverse function names                            /tmp/Rtmpt9wQv5/se… /tmp/… TRUE            TRUE            279
```
