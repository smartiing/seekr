...
#> Common Path: /tmp/RtmppsESWb/seekr-example19f537a5ccbc
#> 
#> R/code.R [1]
#> [1] -> 2 |   # TODO: rename foo
#> 
...
#> /tmp/RtmppsESWb/seekr-example19f537a5ccbc/R/code.R [1]
#> [1] -> 2 |   # TODO: rename foo
#> 
...
#>   <chr>               <lgl>    <lgl>                <lgl>      <lgl>            
#> 1 /tmp/RtmppsESWb/se… FALSE    FALSE                FALSE      FALSE            
#> 2 /tmp/RtmppsESWb/se… TRUE     TRUE                 NA         NA               
#> 3 /tmp/RtmppsESWb/se… FALSE    FALSE                FALSE      FALSE            
