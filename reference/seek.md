...
#> Common Path: /tmp/RtmpudJFVx/seekr-example19f27fb965d2
#> 
#> R/code.R [1]
#> [1] -> 2 |   # TODO: rename foo
#> 
...
#> /tmp/RtmpudJFVx/seekr-example19f27fb965d2/R/code.R [1]
#> [1] -> 2 |   # TODO: rename foo
#> 
...
#>   <chr>               <lgl>    <lgl>                <lgl>      <lgl>            
#> 1 /tmp/RtmpudJFVx/se… FALSE    FALSE                FALSE      FALSE            
#> 2 /tmp/RtmpudJFVx/se… TRUE     TRUE                 NA         NA               
#> 3 /tmp/RtmpudJFVx/se… FALSE    FALSE                FALSE      FALSE            
